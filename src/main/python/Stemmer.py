...
class Stemmer:
    ...
    # Word regions.
    _re_rv = re.compile(_vowel)                 # область слова после первого сочетания "гласная-согласная".
    _re_r1 = re.compile(_vowel + _non_vowel)    # область R1 после первого сочетания "гласная-согласная".
